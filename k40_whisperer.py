...
class Application(Frame):
    ...
    def createWidgets(self):
        ...
        if DEBUG:
            top_View.add_checkbutton(label="Show Raster Paths", variable=self.include_Rpth,
                                     command=self.menu_View_Refresh)

        top_View.add_checkbutton(label="Show Vector Engrave", variable=self.include_Veng,
                                 command=self.menu_View_Refresh)
        ...
        top_View.add_separator()
        top_View.add_checkbutton(label="Show Time Estimates", variable=self.include_Time,
                                 command=self.menu_View_Refresh)
        ...
        top_Settings.add_checkbutton(label="Advanced Settings <F6>", variable=self.advanced,
                                     command=self.menu_View_Refresh)
    ...
    def refreshTime(self):
        ...
        if self.GcodeData.ecoords == []:
            ...
            self.PreviewCanvas.create_text(HUD_X, HUD_Y - HUD_vspace, fill="blue", text=self.Veng_time.get(),
                                           anchor="se", tags="HUD")
            ...
            self.PreviewCanvas.create_text(HUD_X, HUD_Y, fill="black", text=self.Gcde_time.get(), anchor="se",
                                           tags="HUD")
        ##########################################
        ...
        try:
            ...
            if (operation_type.find("Vector_Eng") > -1) and (self.VengData.ecoords != []):
                ...
                if not self.VengData.sorted and self.inside_first.get():
                    self.VengData.set_ecoords(self.optimize_paths(self.VengData.ecoords, inside_check=False),
                                              data_sorted=True)
                self.statusMessage.set("Generating EGV data...")
                self.master.update()
        ...
        if abs(self.w - w) > 10 or abs(self.h - h) > 10 or update == 1:
            ...
            if True:
                ...
                if self.GcodeData.ecoords == []:
                    ...
                    Yloc = Yloc - 30
                    self.Prst_Button.place(x=12, y=Yloc, width=200, height=23)
                ...
                if self.advanced.get():
                    ...
                    if h >= 560:
                        ...
                        self.Checkbutton_Halftone_adv.place(x=Xadvanced + w_label_adv + 2, y=adv_Yloc, width=25,
                                                            height=23)

                        adv_Yloc = adv_Yloc + 25
                        self.Label_Negate_adv.place(x=Xadvanced, y=adv_Yloc, width=w_label_adv, height=21)
                        self.Checkbutton_Negate_adv.place(x=Xadvanced + w_label_adv + 2, y=adv_Yloc, width=25,
                                                          height=23)
                        ...
                        self.Checkbutton_Mirror_adv.place(x=Xadvanced + w_label_adv + 2, y=adv_Yloc, width=25,
                                                          height=23)

                        adv_Yloc = adv_Yloc + 25
                        self.Label_Rotate_adv.place(x=Xadvanced, y=adv_Yloc, width=w_label_adv, height=21)
                        self.Checkbutton_Rotate_adv.place(x=Xadvanced + w_label_adv + 2, y=adv_Yloc, width=25,
                                                          height=23)

                        adv_Yloc = adv_Yloc + 25
                        self.Label_inputCSYS_adv.place(x=Xadvanced, y=adv_Yloc, width=w_label_adv, height=21)
                        self.Checkbutton_inputCSYS_adv.place(x=Xadvanced + w_label_adv + 2, y=adv_Yloc, width=25,
                                                             height=23)
                        ...
                        self.Checkbutton_Inside_First_adv.place(x=Xadvanced + w_label_adv + 2, y=adv_Yloc, width=25,
                                                                height=23)

                        adv_Yloc = adv_Yloc + 25
                        self.Label_Rotary_Enable_adv.place(x=Xadvanced, y=adv_Yloc, width=w_label_adv, height=21)
                        self.Checkbutton_Rotary_Enable_adv.place(x=Xadvanced + w_label_adv + 2, y=adv_Yloc, width=25,
                                                                 height=23)
                    else:
                    ...
                    if self.GcodeData.ecoords == []:
                        ...
                        self.Checkbutton_Comb_Vector_adv.place(x=Xadvanced + w_label_adv + 2, y=adv_Yloc, width=25,
                                                               height=23)

                        adv_Yloc = adv_Yloc - 25
                        self.Label_Comb_Engrave_adv.place(x=Xadvanced, y=adv_Yloc, width=w_label_adv, height=21)
                        self.Checkbutton_Comb_Engrave_adv.place(x=Xadvanced + w_label_adv + 2, y=adv_Yloc, width=25,
                                                                height=23)
                        ####
                        ...
                        self.Entry_Gcde_passes.place(x=Xadvanced + w_label_adv + 2, y=adv_Yloc, width=w_entry,
                                                     height=23)
    ...
    def GEN_Settings_Window(self):
        ...
        self.Checkbutton_post_exec = Checkbutton(gen_settings, text="Run Batch File:", anchor=W,
                                                 command=self.Set_Input_States_BATCH)
    ...
    def RASTER_Settings_Window(self):
        ...
        self.Checkbutton_Halftone = Checkbutton(raster_settings, text=" ", anchor=W,
                                                command=self.Set_Input_States_RASTER)
        ...
        x, y = self.generate_bezier(M1, M2, w, n=num)
        for i in range(0, num):
            self.BezierCanvas.create_line(5 + x[i], 260 - y[i], 5 + x[i + 1], 260 - y[i + 1], fill="grey85",
                                          stipple='gray25', \
    ...
    def ROTARY_Settings_Window(self):
        ...
        self.Checkbutton_Rotary_Enable = Checkbutton(rotary_settings, text="", anchor=W,
                                                     command=self.Set_Input_States_Rotary)
